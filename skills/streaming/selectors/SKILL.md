...
plain selector arguments as the helper args tuple; selector-channel effects read
Redux state from saga context and do not subscribe to direct Kefir `Observable`,
Svelte readable, or React signal selector outputs.
