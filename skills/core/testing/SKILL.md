...
description: >-
  ...
  @augmentcode/themis/docs/TESTING.md, ./SKILL.md#layer-rules.
type: sub-skill
library: themis
requires:
  - core
...
> Operational testing checklist. Human-facing examples: `@augmentcode/themis/docs/TESTING.md`. Saga effect details: `../sagas/SKILL.md`. Canonical checklist: [Layer rules](./SKILL.md#layer-rules) and [Saga test setup cues](./SKILL.md#saga-test-setup-cues).
